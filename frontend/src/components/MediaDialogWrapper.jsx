    ...
    <React.Fragment>
      ...
      >
        ...
        <DialogContent>
          ...
          <Button onClick={() => handleTagClick('video')} startIcon={<YouTube />}>
            Video URL
          </Button>
          <Button onClick={() => handleTagClick('image')} startIcon={<InsertPhoto />}>
            Image
          </Button>
          <Divider sx={{ pt: 2 }} />
          <Box sx={{ pt: 2 }}>
            {props.selectedTag === 'video' && (
              <Stack direction='row' spacing={2}>
                ...
                />
                <Button onClick={handleVideoTextField} variant='contained'>Confirm</Button>
              </Stack>
            )}
            {props.selectedTag === 'image' && (
              <Box>
                <Button variant="contained" component="label" startIcon={<InsertPhoto />} fullWidth>
                  Upload Image
        ...
        <DialogActions>
          <Button onClick={handleClear} disabled={!props.selectedTag} variant='outlined'>Clear</Button>
